...
public abstract class AbstractUserData {
	...
	public AbstractUserData(String title, String description, String userData) {
		this.title = title;
		this.description = description;
		this.userData = userData;
	}
	
	public AbstractUserData(int userDataId, String title, String description, String userData) {
