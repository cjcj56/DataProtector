...
public class OldKeys {
	...
	private OldKeys(BigInteger mod, BigInteger publicKey, BigInteger privateKey) {
		this.mod = mod;
		this.privateKey = privateKey;
		this.publicKey = publicKey;
	}
	
	public OldKeys(String n, String e, String d) {
		this(new BigInteger(n), new BigInteger(e), new BigInteger(d));
	}

	public static OldKeys generateKeys() {
